...
/* ---- 卡牌 ---- */
const C = {
  strike:{h:'A',n:'打擊',c:1,atk:6,d:'造成6傷'},
  heavy:{h:'A',n:'重擊',c:2,atk:12,fac:'爆發',d:'造成12傷'},
  focus:{h:'A',n:'蓄力',c:1,focus:1,fac:'爆發',d:'獲得1層蓄力，下次攻擊+5傷'},
  barrage:{h:'A',n:'連射',c:1,atk:3,hits:2,fac:'連擊',d:'造成3傷×2次'},
  ember:{h:'A',n:'餘燼',c:1,burn:3,fac:'連擊',d:'使目標灼傷3（每回合損血，逐漸衰減）'},
  guardself:{h:'A',n:'護體',c:1,selfblock:5,d:'自身獲得5格擋'},
  gift:{h:'A',n:'送能量→隊友',c:0,cross:'energy',bond:1,d:'隊友獲得1能量。+1羈絆'},
  resonate:{h:'A',n:'共鳴斬',c:1,atk:6,bondcost:2,bonus:12,fac:'借力',d:'消耗2羈絆，造成6+12傷'},

  block:{h:'B',n:'格擋',c:1,selfblock:6,d:'自身獲得6格擋'},
  ironwall:{h:'B',n:'鐵壁',c:1,selfblock:12,fac:'銅牆',d:'自身獲得12格擋'},
  shield:{h:'B',n:'護盾→隊友',c:1,cross:'block',v:8,bond:1,d:'隊友獲得8格擋。+1羈絆'},
  inspire:{h:'B',n:'鼓舞→隊友',c:1,cross:'empower',v:5,bond:1,fac:'增幅',d:'賦予隊友鼓舞5（下次攻擊+5傷）。+1羈絆'},
  battlefield:{h:'B',n:'戰域',c:1,cross:'battlefield',v:3,bond:1,fac:'增幅',d:'賦予隊友戰域3（本回合攻擊+3）。+1羈絆'},
  heal:{h:'B',n:'治療→隊友',c:2,cross:'heal',v:9,bond:1,rev:true,fac:'慈光',d:'恢復隊友9HP，可救起倒地隊友。+1羈絆'},
  taunt:{h:'B',n:'嘲諷',c:1,taunt:true,bond:1,fac:'銅牆',d:'嘲諷所有敵人攻擊自身。若敵有護甲，令其破綻2回合。+1羈絆'},
  reflect:{h:'B',n:'反震',c:1,reflectatk:true,fac:'銅牆',d:'消耗自身全部格擋，對敵造成等量傷害（無視護甲）'},
  resonance:{h:'B',n:'共振',c:0,bond:2,noblock:true,fac:'增幅',d:'獲得2羈絆，本回合無法獲得格擋'},
  // 新增卡(擴流派)
  thousand:{h:'A',n:'千刃',c:2,atk:2,hits:4,fac:'連擊',d:'造成2傷×4次'},
  cleave:{h:'A',n:'裂斬',c:2,atk:9,fac:'爆發',d:'造成9傷'},
  rain:{h:'B',n:'甘霖',c:2,cross:'healboth',v:5,bond:1,fac:'慈光',d:'恢復雙方各5HP。+1羈絆'},
  command:{h:'B',n:'傳令',c:1,cross:'battlefield',v:6,bond:1,fac:'增幅',d:'賦予隊友戰域6（本回合攻擊+6）。+1羈絆'},
  // ③效果詞條卡(帶制約)
  bloodblade:{h:'A',n:'血刃',c:1,atk:16,selfharm:4,fac:'爆發',d:'造成16傷，但自傷4HP'},
  insight:{h:'A',n:'洞察',c:0,draw:2,d:'抽2張牌'},
  warcry:{h:'A',n:'戰意',c:1,sustain:2,sustainRounds:3,fac:'連擊',d:'獲得持攻2，持續3回合（每回合攻擊+2，逐回合衰減）'},
  tempo:{h:'B',n:'節奏',c:1,extraDraw:1,drawRounds:3,fac:'增幅',d:'獲得連抽1，持續3回合（每回合開始多抽1張）'},
  rally:{h:'B',n:'激勵',c:2,teamAtk:2,teamRounds:2,bond:1,fac:'增幅',d:'全隊攻擊+2，持續2回合。+1羈絆'},
  weaken:{h:'B',n:'弱化',c:1,weaken:6,weakenRounds:2,fac:'銅牆',d:'使目標弱化6（攻擊-6，持續2回合；疊加上限-10）'},
  // 共通牌池(中立·兩人都能抽·增加流派可能性、給凪輸出agency但不變第二個炎)
  quickjab:{h:'*',n:'速刺',c:1,atk:5,fac:'通用',d:'造成5傷'},
  siphon:{h:'*',n:'汲取',c:1,draw:1,selfblock:3,fac:'通用',d:'抽1張牌，自身獲得3格擋'},
  bondknot:{h:'*',n:'羈絆結',c:0,bond:1,fac:'通用',d:'+1羈絆'},
  coverguard:{h:'*',n:'覆盾→隊友',c:1,cross:'block',v:5,fac:'通用',d:'隊友獲得5格擋'},
  // 凪新輸出(專屬·防禦即輸出=為自己而非只服務炎)
  thornshield:{h:'B',n:'棘盾',c:1,blockdmg:true,fac:'銅牆',d:'造成等於自身當前格擋的傷害（無視護甲）；之後格擋減半'},
  // 丸子(控制/狀態流·debuff疊加→計數爆發·放大隊友)
  tint:{h:'M',n:'上色',c:1,vuln:2,fac:'調色',d:'使目標易傷+2（受傷增加+25%/層，上限6層）'},
  miasma:{h:'M',n:'瘴氣',c:1,burn:3,weaken:4,weakenRounds:2,fac:'調色',d:'使目標灼傷3、弱化4（持續2回合）'},
  wither:{h:'M',n:'枯萎',c:2,weakenAll:6,fac:'調色',d:'使所有敵人弱化6（攻擊-6，持續2回合）'},
  bloom:{h:'M',n:'綻放',c:2,debuffBurst:3,fac:'調色',d:'對目標造成傷害，等於其身上每層異常狀態×3'},
  // 金魚(速攻/連打tempo·出牌越多滾越大·吃雙方出牌數=co-op tempo)
  streamdraw:{h:'F',n:'川流',c:1,draw:2,fac:'速攻',d:'抽2張牌'},
  dartvolley:{h:'F',n:'飛鏢',c:1,atk:3,hits:3,fac:'速攻',d:'造成3傷×3次'},
  flurry:{h:'F',n:'亂舞',c:1,comboAtk:3,per:2,fac:'速攻',d:'造成傷害等於3加上本輪雙方已出牌數×2'},
  crescendo:{h:'F',n:'漸強',c:2,comboAtk:4,per:3,fac:'速攻',d:'造成傷害等於4加上本輪雙方已出牌數×3'},
  // 召喚物共通卡(God Field 式亂數item感·主角後敵人前自動行動·持續數回合)
  sprite:{h:'*',n:'召喚·治療靈',c:1,summon:{kind:'heal',v:4,rounds:3},fac:'召喚',d:'召喚治療靈：每回合隨機恢復一位隊友4HP，持續3回合'},
  dartsprite:{h:'*',n:'召喚·箭靈',c:1,summon:{kind:'attack',v:5,rounds:3},fac:'召喚',d:'召喚箭靈：每回合隨機攻擊一個敵人5傷，持續3回合'},
  wisp:{h:'*',n:'召喚·亂靈',c:1,summon:{kind:'random',v:6,rounds:3},fac:'召喚',d:'召喚亂靈：每回合隨機恢復一位隊友6HP或攻擊一個敵人6傷，持續3回合'},
  // 屬性元素卡(共通·打對弱點×1.5·打抗性×0.5)
  flamedart:{h:'*',n:'火矢',c:1,atk:6,elem:'fire',fac:'元素',d:'造成6火傷（弱點目標×1.5）'},
  frostdart:{h:'*',n:'冰矢',c:1,atk:6,elem:'ice',fac:'元素',d:'造成6冰傷（弱點目標×1.5）'},
  zap:{h:'*',n:'電矢',c:1,atk:6,elem:'thunder',fac:'元素',d:'造成6雷傷（弱點目標×1.5）'},
  // AoE(補玩家端範圍傷缺口·多敵人戰答案)
  scatter:{h:'*',n:'散射',c:2,atk:4,aoe:true,fac:'範圍',d:'對所有敵人各造成4傷'},
  tidalwave:{h:'F',n:'浪潮',c:2,atk:5,aoe:true,fac:'速攻',d:'對所有敵人各造成5傷'},
  plague:{h:'M',n:'疫',c:2,vulnAll:2,fac:'調色',d:'使所有敵人易傷+2'},
  // 營火/商人升級版(卡片編號強化·擴充升級路徑)
  strikeP:{h:'A',n:'打擊+',c:1,atk:9,d:'造成9傷'},
  heavyP:{h:'A',n:'重擊+',c:2,atk:16,fac:'爆發',d:'造成16傷'},
  blockP:{h:'B',n:'格擋+',c:1,selfblock:9,d:'自身獲得9格擋'},
  shieldP:{h:'B',n:'護盾+→隊友',c:1,cross:'block',v:12,bond:1,d:'隊友獲得12格擋。+1羈絆'},
  barrageP:{h:'A',n:'連射+',c:1,atk:4,hits:3,fac:'連擊',d:'造成4傷×3次'},
  thousandP:{h:'A',n:'千刃+',c:2,atk:3,hits:4,fac:'連擊',d:'造成3傷×4次'},
  cleaveP:{h:'A',n:'裂斬+',c:2,atk:13,fac:'爆發',d:'造成13傷'},
  bloodbladeP:{h:'A',n:'血刃+',c:1,atk:22,selfharm:4,fac:'爆發',d:'造成22傷，但自傷4HP'},
  warcryP:{h:'A',n:'戰意+',c:1,sustain:3,sustainRounds:3,fac:'連擊',d:'獲得持攻3，持續3回合（每回合攻擊+3，逐回合衰減）'},
  weakenP:{h:'B',n:'弱化+',c:1,weaken:9,weakenRounds:2,fac:'銅牆',d:'使目標弱化9（攻擊-9，持續2回合；疊加上限-10）'},
  inspireP:{h:'B',n:'鼓舞+→隊友',c:1,cross:'empower',v:8,bond:1,fac:'增幅',d:'賦予隊友鼓舞8（下次攻擊+8傷）。+1羈絆'},
  ironwallP:{h:'B',n:'鐵壁+',c:1,selfblock:16,fac:'銅牆',d:'自身獲得16格擋'},
  healP:{h:'B',n:'治療+→隊友',c:2,cross:'heal',v:13,bond:1,rev:true,fac:'慈光',d:'恢復隊友13HP，可救起倒地隊友。+1羈絆'},
  rallyP:{h:'B',n:'激勵+',c:2,teamAtk:3,teamRounds:2,bond:1,fac:'增幅',d:'全隊攻擊+3，持續2回合。+1羈絆'},
  commandP:{h:'B',n:'傳令+',c:1,cross:'battlefield',v:9,bond:1,fac:'增幅',d:'賦予隊友戰域9（本回合攻擊+9）。+1羈絆'},
  // 紀念卡(清困難房間獲得·獨特強卡、不進一般 draft)
  memento_a:{h:'A',n:'深海之證',c:1,atk:8,aoe:true,bond:2,fac:'紀念',d:'對所有敵人造成8傷，獲得2羈絆'},
  memento_b:{h:'B',n:'守護之潮',c:2,selfblock:10,cross:'block',v:10,bond:2,fac:'紀念',d:'自身和隊友各獲得10格擋，獲得2羈絆'},
};
...
const HERO_DEFS = {
  yugan: {name:'魚乾', role:'attacker', hp:42, passive:'firstStrike', pdesc:'首擊爆發:每場戰鬥首次攻擊+3傷', start:['strike','guardself','gift','heavy','focus','barrage'],
         pool:['heavy','focus','barrage','ember','resonate','guardself','thousand','cleave','bloodblade','insight','warcry']},
  shuimu:{name:'水母', role:'guardian', hp:56, passive:'startBlock', pdesc:'潮護:每場戰鬥開場自帶5格擋', start:['block','shield','inspire','taunt','heal','ironwall'],
  ...
  wanzi:{name:'丸子', role:'control', hp:48, passive:'startDraw', pdesc:'洞悉:每場戰鬥開場多抽1張(utility·不加傷)', start:['tint','miasma','weaken','quickjab','guardself','bloom'],
         pool:['tint','miasma','wither','bloom','weaken','ember','quickjab','coverguard','siphon','insight','plague']},
  jin:  {name:'金魚', role:'tempo', hp:46, maxE:4, passive:'startDraw', pdesc:'手感:每場戰鬥開場多抽1張(不加能量·避免首回合爆)', start:['dartvolley','streamdraw','flurry','quickjab','barrage','crescendo'],
...
const MAP = [ // 兩章·第一章(淺海)→第二章(深淵)、越後越硬。fork=可選路;隱藏boss=條件解鎖
  // 第一章·淺海(前期就給構築機會:寶箱拿牌→商店精簡/補強、早段就能捏牌組)
  {t:'battle',e:'slime'},{t:'battle',e:'crab'},{t:'chest'},{t:'shop'},{t:'battle',e:'eel'},{t:'campfire'},{t:'relic'},
  {t:'battle',e:'priest'},{t:'chest'},{t:'battle',e:'murk'},{t:'campfire'},
